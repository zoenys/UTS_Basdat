                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                        <div class="menu-main d-flex align-items-center justify-content-end">
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="doctor.html">Psychologist</a></li>
                            ...
                            <div class="header-right-btn f-right d-none d-lg-block ml-30">
                                <a href="{{ url('/login') }}" class="btn header-btn">Log In</a>
                            </div>                            
                        </div>
                    </div>   
                    <!-- Mobile Menu -->
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.1s">Mental health is crucial as it affects how we think, feel, and act, influencing our overall well-being, relationships, and ability to cope with life’s challenges.</p>
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Start Consul <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.1s">Stress itu berat, biar aku saja.</p>
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Start Consul <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <div class="about-btn1 mb-30">
                            <a href="about.html" class="btn about-btn2">Start Consul <i class="ti-arrow-right"></i></a>
                        </div>
                        <div class="about-btn1 mb-30">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    ...
                                    <a href="#" class="dep-btn">Start Consul<i class="ti-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-5">
